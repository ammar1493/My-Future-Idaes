...
// Peer-to-peer (mesh) WebRTC room — the zero-dependency fallback used when
// LiveKit is not configured. Each browser connects to our signaling websocket,
// which also records join/leave/heartbeat events that the attendance engine
// turns into a register. Best for small classes.
const RTC_CONFIG = {
